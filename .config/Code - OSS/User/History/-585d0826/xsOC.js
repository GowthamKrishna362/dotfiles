...
<<<<<<< HEAD
export const selectShareVisibilityDetails = createSelector([selectQueryDetails], (queryDetails = {}) => {
  const { visibleSharesCount = null, fullyAccessibleForUser } = queryDetails;
  return {
    fullyAccessibleForUser,
    visibleSharesCount,
  };
});
=======
...
>>>>>>> 1a9457e88e0d376414ec68144ac888860a6ee983
